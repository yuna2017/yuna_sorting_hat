...
export function ShareWebPanel({ url, text }: ShareWebPanelProps) {
  ...
  const handleSystemShare = useCallback(async () => {
    try {
      await navigator.share({ title: 'YUNA 分部帽', text, url })
    } catch {
