...
export function ShareBar({
  ...
  return (
    <section className="share-bar w-full" aria-labelledby="share-bar-title">
      <h2 id="share-bar-title" className="text-sm tracking-[0.16em] text-parchment-dim">分享你的结果</h2>
